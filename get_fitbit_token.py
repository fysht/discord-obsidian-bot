...
def main():
    if not CLIENT_ID or not CLIENT_SECRET:
        print(
            "エラー: 環境変数 (FITBIT_CLIENT_ID, FITBIT_CLIENT_SECRET) が見つかりません。"
        )
    ...
    print(
        "【ステップ1】ブラウザの「新しい空のタブ」を開き、以下のURLを貼り付けてアクセスしてください。"
    )
    print("-" * 60)
    print(auth_url)
    print("-" * 60)
    ...
    redirected_url = input(
        "その後、飛ばされた画面（真っ白でOK）のURLをすべてコピーし、ここに貼り付けてEnterを押してください:\n> "
    )
