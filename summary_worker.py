...
4. 【最重要】AIの投稿内容や、AIからの返答を推測して含めないでください。整理の対象はユーザー（私）の投稿内容のみとしてください。
5. 【重要】「AIと話した」「Discordに投稿した」といった行動自体は記録せず、完全にユーザー自身が手動で書いたノートとして、「〇〇をした」「〇〇をしたい」「〇〇について考えた」という一人称視点の事実や思考として記述してください。

【出力構成】
後で見返しやすいよう、必ず以下の順番と見出しで整理して出力してください。該当する内容がないセクションは省略して構いません。
### 📝 Events & Actions
### 💡 Insights & Thoughts
### ➡️ Next Actions
