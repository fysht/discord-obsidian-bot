...
class ScreenerService:
    ...
    def build_phase_b_prompt(candidate: dict, constitution_excerpt: str = "") -> str:
        ...
        return (
            ...
            "**書き方**: 専門用語はできるだけ避け、投資初心者にも分かるやさしい言葉で説明してください。"
            "むずかしい用語を使うときは、すぐ後ろに（かっこ書き）で短い言い換えを添えてください。\n"
    ...
    def build_business_model_prompt(code: str, name: str = "") -> str:
        ...
        return (
            ...
            "**書き方**: 専門用語はできるだけ避け、投資初心者にも分かるやさしい言葉で。むずかしい用語は（かっこ書き）で短く言い換えを添える。\n"
    ...
    def build_phase_c_prompt(style_display: str, results_with_qualitative: list[dict]) -> str:
        ...
        lines = [
            ...
            "",
            "**書き方**: 専門用語はできるだけ避け、投資初心者にも分かるやさしい言葉で説明してください。むずかしい用語を使うときは（かっこ書き）で短い言い換えを添えてください。",
