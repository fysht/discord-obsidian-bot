...
SCHEDULE_CATALOG: list[dict] = [
    ...
    {"key": "lunch_meal",             "label": "昼食ログ",                "time": "13:00", "dow": "daily",  "category": "manager", "description": "昼ごはんを記録する質問を投下。"},
    ...
    {"key": "dinner_meal",            "label": "夕食ログ",                "time": "19:00", "dow": "daily",  "category": "manager", "description": "晩ごはんを記録する質問を投下。"},
